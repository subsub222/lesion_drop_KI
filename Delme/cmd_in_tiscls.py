...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--conffile', default='./config/lesion_tiscls.py', type=str, help='')
    ...
    parser.add_argument('--mode', default='tiscls', type=str, help='')
    parser.add_argument('--gain', action='store_true', help='')
    parser.add_argument('--gaintype', default='per', type=str, help=' per | total ')
    return parser
